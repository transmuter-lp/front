...
class TokenType(BaseTokenType):
    Whitespace = BaseTokenType(False)
    Identifier = BaseTokenType(False)
    Colon = BaseTokenType(False)
    Semicolon = BaseTokenType(False)
    CommercialAt = BaseTokenType(False)
    LeftParenthesis = BaseTokenType(False)
    RightParenthesis = BaseTokenType(False)
    GreaterThanSign = BaseTokenType(False)
    VerticalLine = BaseTokenType(False)
    Solidus = BaseTokenType(False)
    DoubleVerticalLine = BaseTokenType(False)
    Comma = BaseTokenType(False)
    DoubleAmpersand = BaseTokenType(False)
    Ignore = BaseTokenType(False)
    Optional = BaseTokenType(False)
    Start = BaseTokenType(False)
    Asterisk = BaseTokenType(False)
    PlusSign = BaseTokenType(False)
    QuestionMark = BaseTokenType(False)
    ExpressionRange = BaseTokenType(False)
    LeftCurlyBracket = BaseTokenType(False)
    LeftCurlyBracketSolidus = BaseTokenType(False)
    RightCurlyBracket = BaseTokenType(False)
    OrdChar = BaseTokenType(False)
    QuotedChar = BaseTokenType(False)
    FullStop = BaseTokenType(False)
    BracketExpression = BaseTokenType(False)
    ExclamationMark = BaseTokenType(False)
    LeftSquareBracket = BaseTokenType(False)
    LeftSquareBracketSolidus = BaseTokenType(False)
    RightSquareBracket = BaseTokenType(False)
