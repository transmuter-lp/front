...
- Recursive Ascent-based left-recursion implementation
    - Node reparenting similar to tail recursive parser
...
- WIKIPEDIA CONTRIBUTORS. **Tail recursive parser**. Available at: https://en.wikipedia.org/wiki/Tail_recursive_parser.
